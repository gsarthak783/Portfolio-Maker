  ...
  return (
    ...
    >
      ...
      <header className="text-center mb-6">
        <h1 className="text-3xl font-bold text-blue-600 tracking-wide uppercase">{fullName}</h1>
        <div className="flex flex-wrap justify-center gap-4 mt-2 text-sm text-blue-600">
          ...
          {footerLinks?.linkedin && (
            <a href={footerLinks.linkedin} target="_blank" rel="noopener noreferrer" className="hover:underline">
              LinkedIn
            </a>
          )}
          {footerLinks?.github && (
            <a href={footerLinks.github} target="_blank" rel="noopener noreferrer" className="hover:underline">
              GitHub
            </a>
          )}
      ...
      {skills.length > 0 && (
        <section className="mb-6">
          <h2 className="text-lg font-semibold mb-2 text-blue-600">Technical Skills</h2>
          <div className="flex flex-wrap gap-2 text-sm">
            {skills.map((skill, idx) => (
              <span key={idx} className="px-2 py-1 bg-gray-100 border border-blue-200 text-blue-700 rounded">
                {skill}
              </span>
            ))}
          </div>
      ...
      {certificates.length > 0 && (
        <section className="mb-6">
          <h2 className="text-lg font-semibold mb-2 text-blue-600">Certifications</h2>
...
export default ITProfessionalResume;
