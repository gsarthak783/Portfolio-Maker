  ...
  return (
    ...
    >
      ...
      <header className="text-center mb-6 border-b-2 border-gray-300 pb-4">
        <h1 className="text-4xl font-bold uppercase tracking-wide">{fullName}</h1>
      ...
      {personalInfo?.summary && (
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-black">Professional Summary</h2>
      ...
      {experiences.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-black">Work Experience</h2>
      ...
      {projects.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-black">Projects</h2>
        ...
        <section className="mb-6">
          ...
          <div className="flex flex-wrap gap-2 text-sm">
            {skills.map((skill, idx) => (
              <span
                key={idx}
                className="px-2 py-1 bg-blue-100 text-blue-800 border border-blue-600 rounded"
              >
                {skill}
              </span>
            ))}
      ...
      {certificates.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-2 text-black">Certifications</h2>
