...
//   } = useForm({
//     defaultValues: {
//       summaryPoints: [""], // Initialize with one empty point
//     },
//   });

//   const { fields, append, remove } = useFieldArray({
//     control,
//     name: "summaryPoints", // Key for the dynamic array
//   });

//   const onSubmit = async (data) => {
//     let result = await axios.post('http://localhost:4000/experience/post-data', data) 
//     console.table("Form Data:", result.data);
//     reset();
//   };
